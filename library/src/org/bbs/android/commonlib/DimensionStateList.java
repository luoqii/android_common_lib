...
public class DimensionStateList implements Parcelable {
   ...
   private static final SparseArray<WeakReference<DimensionStateList>> sCache =
                           new SparseArray<WeakReference<DimensionStateList>>();
    ...
    * states to colors.
    */
   public DimensionStateList(int[][] states, int[] colors) {
       mStateSpecs = states;
       mColors = colors;
    ...
    */
   public static DimensionStateList valueOf(int color) {
       // TODO: should we collect these eventually?
       synchronized (sCache) {
           WeakReference<DimensionStateList> ref = sCache.get(color);
           DimensionStateList csl = ref != null ? ref.get() : null;

           if (csl != null) {
               return csl;
           }

           csl = new DimensionStateList(EMPTY, new int[] { color });
           sCache.put(color, new WeakReference<DimensionStateList>(csl));
           return csl;
       }
   }
    ...
    */
   public static DimensionStateList createFromXml(Resources r, XmlPullParser parser)
    ...
    */
   private static DimensionStateList createFromXmlInner(Resources r, XmlPullParser parser,
           AttributeSet attrs) throws XmlPullParserException, IOException {

       DimensionStateList colorStateList;

       final String name = parser.getName();

       if (name.equals("selector")) {
           colorStateList = new DimensionStateList();
       } else {
   ...
   private void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
       ...
       while ((type=parser.next()) != XmlPullParser.END_DOCUMENT
           ...
           for (i = 0; i < numAttrs; i++) {
               ...
               if (stateResId == android.R.attr.value) {
